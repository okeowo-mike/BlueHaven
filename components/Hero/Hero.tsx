      ...
      <div className={styles.heroContent}>
        <div className={styles.heroText}>
          ...
          <p className={styles.subtitle}>
            Discover your perfect getaway in our meticulously designed accommodation, 
            ...
            <div className={styles.results}>
              <div className={styles.resultsHeader}>
                ...
                <span className={styles.priceHighlight}>
                  ${availability.pricePerNight} <span className={styles.perNight}>/ night</span>
                </span>
              </div>

              <div className={styles.priceBreakdown}>
                <div className={styles.priceRow}>
                  <span>${availability.pricePerNight} x {availability.totalNights} nights</span>
                ...
                <div className={`${styles.priceRow} ${styles.totalRow}`}>
                  <span>Total</span>
                  <span>${availability.totalPrice + availability.cleaningFee + availability.serviceFee}</span>
                </div>
              </div>
